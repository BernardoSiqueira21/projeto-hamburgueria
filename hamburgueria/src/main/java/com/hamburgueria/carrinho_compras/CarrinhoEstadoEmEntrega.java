...
public class CarrinhoEstadoEmEntrega implements CarrinhoEstado {

    private final CarrinhoSnapshot snap;

    public CarrinhoEstadoEmEntrega(CarrinhoSnapshot snap) {
        this.snap = snap;
    }

    @Override public String       getStatus()      { return "EM_ENTREGA"; }
